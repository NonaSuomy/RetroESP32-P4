...
static const doom_keymap_t keymap[] = {
    ...
    {PAPP_INPUT_L,      &key_strafeleft},
    {PAPP_INPUT_R,      &key_straferight},
...
void I_StartTic(void)
{
    ...
    /* Feed relative USB mouse motion through Doom's existing joystick path.
     * This keeps the PAPP ABI independent of Doom's disabled ev_mouse code:
     * left click=fire, right click=strafe, middle click=use. */
    if (_papp_svc->input_mouse_read) {
